...
(* This is one of those odd instructions like dec_chk
...
Get first object contained in a given object, branching if this exists,
i.e. is not 0 *)
...
(* Spec: 10P:142 load (variable) -> (result)
